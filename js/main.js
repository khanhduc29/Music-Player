    ...
    const app = {
        ...
        loadCurrentSong() {
            if(this.isRandom) {
                ...
                cdThumb.style.backgroundImage = `url('${this.randomSongs[this.currentIndex].image}')`
            } else {
        ...
        songs: [
            ...
            },
            {
                ...
                author: 'Sơn Tùng - MTP',
                image: './img/song4.jpg.webp',
                path: './music/song4.mp3'
            },
            {
                name: 'Khuôn mặt đáng thương',
                author: 'Sơn Tùng - MTP',
                image: './img/song5.webp',
                path: './music/song5.mp3'
            },
            {
                name: 'Không phải dạng vừa đâu',
                author: 'Sơn Tùng - MTP',
                image: './img/song6.webp',
                path: './music/song6.mp3'
            },
            {
                name: 'Cơn mưa ngang qua',
                author: 'Sơn Tùng - MTP',
                image: './img/song7.webp',
        ...
        render() {
            let htmls;
            if(this.isRandom) {
                htmls = this.randomSongs.map((song, index) => 
                    `
        ...
        handleRandomSongs() {
            if(this.isRandom) {
                ...
                while(randomSongs.length < lengthSongs) {
                    ...
                    const available = randomSongs.find((randomSong) => randomSong == this.songs[randomIndex]);
                    if(!available) {
        ...
        swapIndex() {
            ...
            let newIndex;
            if(this.isRandom) {
                newIndex = this.randomSongs.indexOf(_this.songs[_this.currentIndex]);
                _this.currentIndex = newIndex;
            }
            else {
                newIndex = this.songs.indexOf(_this.randomSongs[_this.currentIndex]);
                _this.currentIndex = newIndex;   
            }
        },
        nextSong() {
